...
public class MinInclusiveProperty<T extends Comparable<T>> extends SimpleProperty<T> implements ComparableProperty<T> {
	...
	public MinInclusiveProperty() {
		super((Class<T>) comparable());
	}
	
	public MinInclusiveProperty(Class<T> type) {
		super(type);
	}
